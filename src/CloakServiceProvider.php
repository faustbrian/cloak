...
final class CloakServiceProvider extends PackageServiceProvider
{
    ...
    {
        $this->app->singleton(ExceptionSanitizer::class, fn (): PatternBasedSanitizer => PatternBasedSanitizer::fromConfig());

        $this->app->singleton(CloakManager::class, fn (): CloakManager => CloakManager::fromConfig());
    }
