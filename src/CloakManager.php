...
/**
 * Main Cloak manager for exception sanitization.
 *
 * Provides centralized management of exception sanitization with logging
 * support for original exceptions. This class orchestrates the sanitization
 * process, formatter selection, and logging behavior for the entire package.
 *
